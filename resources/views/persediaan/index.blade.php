...
<div id="content" class="content">
    ...
    <h1 class="page-header">Persediaan<small> (Pemesanan Barang)</small></h1>
    <div class="row">
        <div class="col-xl-12">
            <!-- begin panel -->
                        ...
                        <table id="data-table-default" class="table table-striped table-bordered table-td-valign-middle">
                            <thead>
                                <tr>
                                    ...
                                    <th width="12%" data-orderable="false">NO PERSEDIAAN</th>
                            ...
                            <tbody>
                                @foreach($data as $no=>$o)
                                    <tr class="gradeX">
                                        ...
                                        <td>{{$o->no_persediaan}} </td>
                                        <td>Persediaan Masuk pada tanggal {{$o->tanggal}}</td>
                                        <td>{{$o->total_item}}</td>
...
@push('ajax')
    <script>
        ...
        function tambah(id){
            location.assign("{{url('persediaan/form')}}?id="+id)
        }
        function ceklis(id){
            $('#idkey').val(id);
        }
