...
<div id="content" class="content">
    ...
    <h1 class="page-header">Form supplier<small></small></h1>
    <div class="row">
        <div class="col-xl-12">
            <!-- begin panel -->
            <div class="panel panel-inverse" data-sortable-id="form-plugins-1">
                ...
                <div class="panel-body">
					<form id="mydata" action="{{url('/supplier')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <fieldset>
								...
								<div class="row">
									...
									<div class="col-xl-8 offset-xl-2">
										<legend class="no-border f-w-700 p-b-0 m-t-0 m-b-20 f-s-16 text-inverse">Informasi Supplier</legend>
										
										<!-- begin form-group -->
                                        @if($id>0)
										<div class="form-group row m-b-10">
											<label class="col-lg-3 text-lg-right col-form-label">Kode Supplier<span class="text-danger">*</span></label>
											<div class="col-lg-9 col-xl-3">
												<input type="text" name="kode" disabled placeholder="kode" value="{{$data->kode_supplier}}" class="form-control" />
											</div>
										</div>
										@endif
										<div class="form-group row m-b-10">
											<label class="col-lg-3 text-lg-right col-form-label">Nama supplier </label>
